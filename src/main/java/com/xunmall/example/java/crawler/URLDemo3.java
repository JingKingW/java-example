...
public class URLDemo3 {
    ...
    public static void main(String[] args) {
        ...
        //workurl(strurl,1);
        addurl(strurl, 0);
        int runCount = Runtime.getRuntime().availableProcessors();
        System.out.println(runCount << 1);
        ExecutorService executorService = Executors.newFixedThreadPool(runCount << 1);
