 ...
 */
public class SampleEncryptDemo {
    ...
    public static void main(String[] args) throws Exception {
        String miwen = encryptBASE64("abc123".getBytes());
        System.out.println(miwen);
        System.out.println(new String(decryptBASE64(miwen)));
        System.out.println(encryptMD5("abc123"));
        System.out.println(encryptSHA("abc123".getBytes()));
    }
