 ...
 */
public class FilePerformanceExample {
    ...
    public static void main(String[] args) throws IOException {
        ...
        // 存放文件的目录
        final String filepath1 = path + "/io_test/write1.txt";
        final String filepath2 = path + "/io_test/write2.txt";
        final String filepath3 = path + "/io_test/write3.txt";
        final String filepath4 = path + "/io_test/write4.txt";
        final String filepath5 = path + "/io_test/write5.txt";
        final String filepath6 = path + "/io_test/write6.txt";
